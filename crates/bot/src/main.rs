...
async fn main() -> Result<()> {
    ...
    let internal_app = Router::new()
        ...
        .route(
            "/api/service-releases/{org}/{app}",
            get(service_releases::list),
        )
        .route(
            "/api/service-releases/{org}/{app}/promote",
            post(service_releases::promote),
        )
        .route(
        ...
        .route(
            "/api/projects/{org}/archive",
            post(dashboard_api::project_archive_post),
        )
        .route(
            "/api/projects/{org}/delete",
            post(dashboard_api::project_delete_post),
        )
        .route(
        ...
        .route("/api/releases/progress/{org}", get(releases::progress))
